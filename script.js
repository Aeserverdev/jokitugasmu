...
document.addEventListener("DOMContentLoaded", () => {
  ...
  async function loadRiwayat() {
    ...
    try {
      const res = await fetch(`https://script.google.com/macros/s/AKfycbzh8uvVY_BHnXkn3Fi5Rc43nXi9tZ-7XudZUuxyl3v_J_vl8sx1khziAuWeUhvp4HM/exec?action=getRiwayat&npm=${user.npm}`);
  ...
  async function loadPembayaran() {
    ...
    box.textContent = "Memuat data...";
    try {
      const res = await fetch(`https://script.google.com/macros/s/AKfycbzh8uvVY_BHnXkn3Fi5Rc43nXi9tZ-7XudZUuxyl3v_J_vl8sx1khziAuWeUhvp4HM/exec?action=getPembayaran&npm=${user.npm}`);
      const data = await res.json();
